# Bitbucket DC Grafana Dashabords
...
* `overview` - This provides a high-level overview of your instance. It contains metrics such as CPU and Memory utilisation, as well as requests and database metrics.
